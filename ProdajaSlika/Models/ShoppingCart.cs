...
namespace ProdajaSlika.Models
{
    public class ShoppingCart
    {
        ...
        public void AddToCart(Picture pic, int amount)
        {
            var shoppingCartItem =
                    _appDbContext.ShoppingCartItems.SingleOrDefault(
                        s => s.Picture.Id == pic.Id && s.ShoppingCartId == Id);
        ...
        public int RemoveFromCart(Picture pic)
        {
            var shoppingCartItem =
                    _appDbContext.ShoppingCartItems.SingleOrDefault(
                        s => s.Picture.Id == pic.Id && s.ShoppingCartId == Id);
        ...
        public decimal GetShoppingCartTotal()
        {
            var total = _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == Id)
                .Select(c => c.Picture.Price * c.Amount).Sum();
            return total;
        }
    }
}
